...
All notable changes to HypixelClient are documented here. Versions follow semantic versioning.

## [1.0.0] - 2026-08-18

### Added

- Public release under the HypixelClient name
...
- Renamed packages, resources, configuration, and runtime identifiers from EnemyBoxes to HypixelClient
- Added automatic migration from `enemyboxes.json` to `hypixelclient.json`
- Made all third-party event forwarding explicit opt-in and removed the bundled service URL

[1.0.0]: https://github.com/chase-irql/HypixelClient/releases/tag/v1.0.0
