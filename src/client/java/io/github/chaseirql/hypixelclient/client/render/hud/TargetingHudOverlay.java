...
public final class TargetingHudOverlay {
    ...
    public static void render(GuiGraphics graphics, Minecraft client, float tickDelta) {
        ...
        if (HypixelClientState.enabled && HypixelClientState.showFovCircle && HypixelClientState.hasTarget()) {
            renderFovCircle(graphics, client);
        }

        if (client.player != null && (HypixelClientState.snaplinesEnabled || HypixelClientState.autoHuntEnabled)) {
            renderSnaplines(graphics, client, tickDelta);
        }

        if (client.player != null && HypixelClientState.showBoxDistance
                && (HypixelClientState.enabled || HypixelClientState.autoHuntEnabled)) {
    ...
    private static void renderFovCircle(GuiGraphics graphics, Minecraft client) {
        ...
        float radius = HypixelClientState.lockFov;
    ...
    private static void renderSnaplines(GuiGraphics graphics, Minecraft client, float tickDelta) {
        ...
        for (Entity entity : client.level.entitiesForRendering()) {
            ...
            if (HypixelClientState.snaplinesEnabled && HypixelClientState.enabled
                    && entity instanceof LivingEntity living && living.isAlive()
                    && HypixelClientState.matches(living)) {
                include = true;
            }
            if (HypixelClientState.autoHuntEnabled && entity instanceof Shulker shulker && shulker.isAlive()) {
                include = true;
            }
        ...
        int thickness = HypixelClientState.snaplineThickness;
        ...
        for (Entity entity : toRender) {
            ...
            if (HypixelClientState.snaplinesOnlyClosest && !isClosest && !isSecond) continue;
            ...
            if (forward > 0.0) {
                ...
                if (!HypixelClientState.drawOffscreenEnemies) continue;
    ...
    private static void renderBoxDistances(GuiGraphics graphics, Minecraft client, float tickDelta) {
        ...
        for (Entity entity : client.level.entitiesForRendering()) {
            ...
            boolean include = false;
            if (HypixelClientState.enabled && entity instanceof LivingEntity living && living.isAlive()
                    && HypixelClientState.matches(living)) {
                include = true;
            }
            if (HypixelClientState.autoHuntEnabled && entity instanceof Shulker shulker && shulker.isAlive()) {
