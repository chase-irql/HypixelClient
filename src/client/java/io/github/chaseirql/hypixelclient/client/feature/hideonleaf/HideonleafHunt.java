package io.github.chaseirql.hypixelclient.client.feature.hideonleaf;
...
public final class HideonleafHunt {
    ...
    public static void resetState() {
        HypixelClientState.huntLockedShulker = null;
        HypixelClientState.huntTrackedBullet = null;
        HypixelClientState.huntLockedBullet  = null;
    ...
    public static void markBulletUsed(UUID bulletId) {
        ...
        if (bulletId.equals(HypixelClientState.huntTrackedBullet)) {
            HypixelClientState.huntTrackedBullet = null;
        }
        if (bulletId.equals(HypixelClientState.huntLockedBullet)) {
            HypixelClientState.huntLockedBullet = null;
        }
        debugState = "USED";
    ...
    public static void tick(Minecraft client) {
        ...
        HypixelClientState.huntLockedShulker = nearestShulker.getUUID();
        ...
        HypixelClientState.huntTrackedBullet = targetBullet.getUUID();

        double aimReach = client.player.entityInteractionRange() - 0.5d;
        boolean bulletInAimRange = nearestBulletDist <= aimReach;

        HypixelClientState.huntLockedBullet = bulletInAimRange ? targetBullet.getUUID() : null;
