...
public final class HideonleafHunt {
    ...
    public static void resetState() {
        EnemyBoxesState.huntLockedShulker = null;
        EnemyBoxesState.huntTrackedBullet = null;
        EnemyBoxesState.huntLockedBullet  = null;
    ...
    public static void markBulletUsed(UUID bulletId) {
        ...
        if (bulletId.equals(EnemyBoxesState.huntTrackedBullet)) {
            EnemyBoxesState.huntTrackedBullet = null;
        }
        if (bulletId.equals(EnemyBoxesState.huntLockedBullet)) {
            EnemyBoxesState.huntLockedBullet = null;
        }
        debugState = "USED";
    ...
    public static void tick(Minecraft client) {
        ...
        EnemyBoxesState.huntLockedShulker = nearestShulker.getUUID();
        ...
        EnemyBoxesState.huntTrackedBullet = targetBullet.getUUID();

        double aimReach = client.player.entityInteractionRange() - 0.5d;
        boolean bulletInAimRange = nearestBulletDist <= aimReach;

        EnemyBoxesState.huntLockedBullet = bulletInAimRange ? targetBullet.getUUID() : null;
