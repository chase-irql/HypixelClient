package com.teeko.strata.client.debug;
...
public final class DebugDump {
    ...
    public static void dumpNearbyEntities(Minecraft client) {
        ...
        chat(client, "\u00A7e=== Strata Debug Dump ===");
        chat(client, "\u00A7eActive filters: \u00A7f" + StrataState.targets);
        chat(client, "\u00A7eESP enabled: \u00A7f" + StrataState.enabled);
    ...
    private static String getMatchTag(Entity entity) {
        ...
        boolean matched = StrataState.matches(living);
        boolean locked = entity.getUUID().equals(StrataState.lockedTarget);
