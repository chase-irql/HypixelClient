package com.teeko.strata.client.state;
...
/**
 * In-memory settings and transient runtime state shared by Strata's client features.
 * Persistent fields are loaded and saved by {@code StrataConfig}; session-only identifiers
 * are deliberately reset when the client disconnects or a feature stops.
 */
public final class StrataState {
