package com.teeko.strata.client.feature.beachball;
...
public final class BeachballMacro {
    ...
    public static void stopIfRunning(Minecraft client) {
        if (!StrataState.beachballMacroRunning) return;
    ...
    public static void onGameMessage(Component message, boolean overlay) {
        ...
        if (StrataState.beachballMacroRunning) {
    ...
    public static List<String> getDebugLines(Minecraft client) {
        ...
        lines.add("Beachball running=" + (StrataState.beachballMacroRunning ? "ON" : "OFF")
                + " state=" + status);
    ...
    public static UUID getRenderBallId(Minecraft client) {
        if (!StrataState.beachballMacroRunning) return null;
    ...
    public static void requestStopAfterCurrentRound(Minecraft client, String reason) {
        ...
        if (client != null && client.player != null) {
            client.player.displayClientMessage(
                    Component.literal("[Strata] " + cleanReason + " Finishing the current beachball before stopping."),
                    false
            );
        }
    }
    ...
    public static boolean shouldOverrideMovement() {
        return StrataState.beachballMacroRunning;
    }
    ...
    public static Input getDesiredInput() {
        boolean crouch = StrataState.beachballMacroRunning && !returningToStart && StrataState.beachballCrouchEnabled;
        return new Input(
                desiredForward,
                desiredBackward,
                desiredLeft,
    ...
    private static void stopMacroAfterCurrentRound(Minecraft client, String reason) {
        ...
        if (client != null && client.player != null) {
            client.player.displayClientMessage(
                    Component.literal("[Strata] Beachball macro stopped (" + sanitizeReason(reason, "Current round finished") + ")"),
                    false
            );
        }
    }
    ...
    private static boolean stopMacro(Minecraft client, String reason, boolean sendAlert) {
        ...
        onRunningStateChanged(client, false);
        if (client != null && client.player != null) {
            client.player.displayClientMessage(Component.literal("[Strata] Beachball stopped (" + reason + ")"), false);
        }
        ...
        if (!alertQueued && client != null && client.player != null) {
            client.player.displayClientMessage(
                    Component.literal("[Strata] Forced-stop alert not queued. Check bot alert settings."),
                    false
            );
        }
