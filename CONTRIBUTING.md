...
Thanks for improving Strata. Small, focused pull requests are the easiest to review.
...
- Never include credentials or unredacted `strata.json` contents in an issue, commit, or build log.

Bug reports should include the Strata version, Minecraft version, Fabric Loader version, Fabric API
